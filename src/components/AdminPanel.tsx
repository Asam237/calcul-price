    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-blue-100">
          Manage pricing configuration for all categories
        </p>
      </div>
          ...
          <Card key={category} className="slide-in">
            ...
            <div className="space-y-4">
              {items.map((item) => (
                <div
                  key={item.id}
                  className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl border border-gray-200 hover:shadow-md transition-all duration-300"
                >
      ...
      >
        <form onSubmit={handleSubmitAdd(onAddSubmit)} className="space-y-4 p-4">
          <Input
