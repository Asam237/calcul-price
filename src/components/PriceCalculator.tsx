      ...
      <div className="flex-1 overflow-y-auto space-y-4">
        <Card className="floating-animation p-4">
          <div className="text-center mb-4">
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-1">Price Calculator</h3>
            <p className="text-gray-600 text-sm">Enter number of people per age group</p>
          </div>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-3">
              {categoryPrices.map(item => (
                <div key={item.id} className="flex justify-between items-center p-3 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button type="submit" className="flex items-center justify-center space-x-2" size="sm">
                <FaCalculator size={14} />
                <span>Calculate</span>
              </Button>
              <Button type="button" variant="clear" onClick={clearForm} className="flex items-center justify-center space-x-2" size="sm">
                <FaEraser size={14} />
                <span>Clear</span>
              </Button>
            </div>
